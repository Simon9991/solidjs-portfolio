...
export default function Greeting() {
    ...
    return (
        <div class="min-h-screen bg-transparent flex flex-col justify-center pt-24 md:pt-8 items-center p-8 text-center md:mb-0 mb-48">
            <h1 class="text-5xl font-bold mb-6 text-roland-red dark:text-roland-red-light leading-relaxed">
                {t('greeting.hello')}
            </h1>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div class="flex flex-col items-center p-4 bg-white dark:bg-gray-800 dark:bg-opacity-70 dark:backdrop-blur-sm rounded-lg shadow-md transition-all duration-300 hover:shadow-lg">
